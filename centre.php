...
<form method="post" action="centre.php">
<div class="container">
		<div class="row">
		...
		<div class="col-lg-8">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="aname" name="aname" placeholder="Enter Your FullName" style="padding:10px; width:300px;">
	...
	<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="phone" id="phone" class="form-control" placeholder="Password"><br>
			</div>
			<div class="form-group">
	...
	<button type="submit" name="submit" id="submit" value="Signup" class="btn btn-success">Register</button><br>
